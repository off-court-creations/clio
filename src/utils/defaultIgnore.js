//  ── src/utils/defaultIgnore.js ────────────────────────────────────────────
// central place for the built‑in stop‑word list used by `clio init`
...
into is isn't it it's its itself just me more most must mustn't my myself no
...
this those through to too under until up used very was wasn't we we'd we'll we're
